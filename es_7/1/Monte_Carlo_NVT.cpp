...
for(int i=0; i<n_blocchi; i++){
	...
	Averages(i);
	epot_eq[i]=stima_pot;
	pres_eq[i]=stima_pres;
}

stampa_file("epot_eq_S",epot_eq,n_blocchi);
stampa_file("pres_eq_S",pres_eq,n_blocchi);
...
stampa_file("epot_eq_L",epot_eq,n_blocchi);
stampa_file("pres_eq_L",pres_eq,n_blocchi);
...
stampa_file("epot_eq_G",epot_eq,n_blocchi);
stampa_file("pres_eq_G",pres_eq,n_blocchi);
