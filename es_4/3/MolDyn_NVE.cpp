...
for (int i=1; i<=n; i++){
	...
	if(i%10==0){
		Measure();
		T[(i/10)-1]=stima_temp;
		Etot[(i/10)-1]=stima_etot/npart;
		Ekin[(i/10)-1]=stima_kin/npart;
		Epot[(i/10)-1]=stima_pot/npart;
	}
}
...
stampa_file("T_solid",T_ave_smooth,n/100);
stampa_file("Etot_solid",Etot_ave_smooth,n/100);
stampa_file("Ekin_solid",Ekin_ave_smooth,n/100);
stampa_file("Epot_solid",Epot_ave_smooth,n/100);

stampa_file("T_solid_var",T_ave_smooth_var,n/100);
stampa_file("Etot_solid_var",Etot_ave_smooth_var,n/100);
stampa_file("Ekin_solid_var",Ekin_ave_smooth_var,n/100);
stampa_file("Epot_solid_var",Epot_ave_smooth_var,n/100);
...
stampa_file("T_liquid",T_ave_smooth,n/100);
stampa_file("Etot_liquid",Etot_ave_smooth,n/100);
stampa_file("Ekin_liquid",Ekin_ave_smooth,n/100);
stampa_file("Epot_liquid",Epot_ave_smooth,n/100);

stampa_file("T_liquid_var",T_ave_smooth_var,n/100);
stampa_file("Etot_liquid_var",Etot_ave_smooth_var,n/100);
stampa_file("Ekin_liquid_var",Ekin_ave_smooth_var,n/100);
stampa_file("Epot_liquid_var",Epot_ave_smooth_var,n/100);
...
stampa_file("T_gas",T_ave_smooth,n/100);
stampa_file("Etot_gas",Etot_ave_smooth,n/100);
stampa_file("Ekin_gas",Ekin_ave_smooth,n/100);
stampa_file("Epot_gas",Epot_ave_smooth,n/100);

stampa_file("T_gas_var",T_ave_smooth_var,n/100);
stampa_file("Etot_gas_var",Etot_ave_smooth_var,n/100);
stampa_file("Ekin_gas_var",Ekin_ave_smooth_var,n/100);
stampa_file("Epot_gas_var",Epot_ave_smooth_var,n/100);
